...
const VOICES = [
  { id: "Rachel", elevenId: "21m00Tcm4TlvDq8ikWAM", name: "Rachel", desc: "Calm & warm female", gender: "female", tag: "Most Popular" },
  { id: "Drew", elevenId: "29vD33N1CtxCmqQRPOHJ", name: "Drew", desc: "Soothing & grounded male", gender: "male", tag: "Deep" },
  { id: "Sarah", elevenId: "EXAVITQu4vr4xnSDxMaL", name: "Sarah", desc: "Soft & nurturing female", gender: "female", tag: "Gentle" },
  { id: "Adam", elevenId: "pNInz6obpgDQGcFmaJgB", name: "Adam", desc: "Deep & meditative male", gender: "male", tag: "Resonant" },
  { id: "Charlotte", elevenId: "XB0fDUnXU5powFXDhCwa", name: "Charlotte", desc: "Elegant & composed female", gender: "female", tag: "Refined" },
  { id: "Clyde", elevenId: "2EiwWnXFnvU5JabPnv8n", name: "Clyde", desc: "Warm & reassuring male", gender: "male", tag: "Comfort" },
];
    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0f0a1a 0%, #1a1033 30%, #120e24 60%, #0d0b1a 100%)", color: "#e8e0f0", fontFamily: "'Quicksand', 'Segoe UI', sans-serif", position: "relative" }}>
      ...
      <nav style={{ position: "sticky", top: 0, zIndex: 100, background: "rgba(15,10,26,0.8)", backdropFilter: "blur(20px)", borderBottom: "1px solid rgba(255,255,255,0.05)", padding: "16px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <span style={{ fontFamily: "'Playfair Display', serif", fontSize: "20px", fontWeight: 600 }}>MindFlow</span>
        </div>
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "40px 24px 80px", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ background: "rgba(212,165,116,0.08)", border: "1px solid rgba(212,165,116,0.2)", borderRadius: "12px", padding: "12px 16px", marginBottom: "32px", fontSize: "12px", color: "rgba(212,165,116,0.8)", lineHeight: 1.6 }}>
          ⚕️ <strong>Disclaimer:</strong> MindFlow is a wellness tool, not a substitute for professional medical or psychological treatment. If you have ADHD or suspect you do, please consult a licensed healthcare provider.
        </div>
              ...
              <div style={{ animation: "fadeUp 0.6s ease" }}>
                <div style={{ textAlign: "center", marginBottom: "40px" }}>
                  ...
                  <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "15px" }}>
                    ...
                    {!apiKey && <span style={{ color: "#fca5a5" }}> Set your API key first using the button above.</span>}
                  </p>
                </div>
        ...
        {activePage === "create" && showPayment && !paymentComplete && (
          <div style={{ animation: "fadeUp 0.6s ease", maxWidth: "500px", margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: "40px" }}>
              ...
              <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "15px" }}>MindFlow is donation-based. Pay what feels right — minimum $4.</p>
            </div>
            <GlassCard style={{ padding: "32px" }}>
      ...
      <footer style={{ borderTop: "1px solid rgba(255,255,255,0.05)", padding: "32px", textAlign: "center", color: "rgba(255,255,255,0.25)", fontSize: "12px", position: "relative", zIndex: 1 }}>
        <div style={{ marginBottom: "8px", fontFamily: "'Playfair Display', serif", fontSize: "16px", color: "rgba(255,255,255,0.35)" }}>MindFlow</div>
        <div>Self-hypnosis wellness tool — not a substitute for professional care.</div>
        <div style={{ marginTop: "4px" }}>© 2026 MindFlow. All rights reserved.</div>
      </footer>
