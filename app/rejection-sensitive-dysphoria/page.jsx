...
const SEO = {
  ...
  description: "RSD makes perceived rejection feel like physical pain. Self-hypnosis builds emotional armor from the inside. Free 25-minute session.",
  url: "https://www.adhdselfhypnosis.com/rejection-sensitive-dysphoria",
  image: "https://www.adhdselfhypnosis.com/og/rejection-sensitive-dysphoria.jpg",
    ...
    <div style={{ fontFamily: "'Poppins', sans-serif", color: TEXT_DARK, background: BG }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", gap: 60, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 460px", minWidth: 300 }}>
            ...
            <h1 style={{
              ...
              That pain isn't<br />
              <span style={{ color: SAGE }}>weakness.</span><br />
              Your brain just feels rejection<br />
              <span style={{ color: SAGE }}>at full volume.</span>
            </h1>
            ...
            <p style={{
              ...
              Nearly 100% of adults with ADHD experience rejection sensitive dysphoria. Mind Refuge uses targeted self-hypnosis to help you build emotional armor your brain never had.
            </p>
      ...
      {section(
        <>
          ...
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            <BenefitCard icon="🧠" title="Quiets the rejection alarm" iconAnim="iconPulse"
              desc="Hypnotic suggestions target the overactive threat-detection system that turns a neutral comment into a perceived attack — calming it at the source." />
      ...
      {section(
        <>
          ...
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            <TestimonialCard
              quote="Someone left me on read and I spiraled for 6 hours convinced they hated me. After a month of sessions, the same thing happened and I just... let it go."
              name="Zara A." detail="Diagnosed at 32 · Using Mind Refuge for 2 months" />
            <TestimonialCard
              quote="My boss gave me feedback and I didn't cry in the bathroom. For the first time in my career. That's what these sessions did for me."
              name="Chris W." detail="Diagnosed at 35 · Using Mind Refuge for 3 months" />
            <TestimonialCard
              quote="RSD made me avoid everything — relationships, promotions, even friendships. Mind Refuge didn't make the sensitivity disappear, but it gave me space around it."
              name="Elena F." detail="Diagnosed at 40 · Using Mind Refuge for 6 weeks" />
          </div>
          <div style={{
      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 600, margin: "0 auto" }}>
          <h2 style={{
            ...
            You deserve to connect<br /><span style={{ color: SAGE }}>without bracing for pain.</span>
          </h2>
          <p style={{ fontSize: 17, color: TEXT_MID, lineHeight: 1.72, marginBottom: 36 }}>
            The sensitivity is real. But it doesn't have to run your life. Mind Refuge helps you build space around it — 25 minutes at a time.
          </p>
          <CTAButton large>Build your self-hypnosis for free</CTAButton>
