...
const SEO = {
  ...
  description: "Hyperfocus isn't a superpower when you can't control it. Self-hypnosis helps you choose where your attention goes. Free 25-minute session.",
  url: "https://www.adhdselfhypnosis.com/hyperfocus",
  image: "https://www.adhdselfhypnosis.com/og/hyperfocus.jpg",
    ...
    <div style={{ fontFamily: "'Poppins', sans-serif", color: TEXT_DARK, background: BG }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", gap: 60, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 460px", minWidth: 300 }}>
            ...
            <h1 style={{
              ...
              Hyperfocus isn't a<br />
              <span style={{ color: SAGE }}>gift.</span><br />
              Not when you can't<br />
              <span style={{ color: SAGE }}>choose it.</span>
            </h1>
            ...
            <p style={{
              ...
              The ADHD brain doesn't lack attention — it can't regulate it. Mind Refuge uses targeted self-hypnosis to help you steer your focus instead of being hijacked by it.
            </p>
      ...
      {section(
        <>
          ...
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            <BenefitCard icon="🧠" title="Gives you the steering wheel" iconAnim="iconPulse"
              desc="Hypnotic suggestions train your subconscious to recognize when hyperfocus has taken over — and build an internal cue to redirect rather than resist." />
      ...
      {section(
        <>
          ...
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            <TestimonialCard
              quote="I lost an entire Saturday to reorganizing my spice rack while a deadline burned. After a month of sessions, I catch myself entering the tunnel and can choose whether to go in."
              name="Sam D." detail="Diagnosed at 33 · Using Mind Refuge for 3 months" />
            <TestimonialCard
              quote="People say hyperfocus is an ADHD superpower. Try telling that to my kids when I've been on my phone for 4 hours straight. These sessions helped me come back."
              name="Rachel M." detail="Diagnosed at 38 · Using Mind Refuge for 2 months" />
            <TestimonialCard
              quote="I can finally hyperfocus on the right things more often. Not perfectly. But the ratio shifted. And that's everything."
              name="Amir K." detail="Diagnosed at 25 · Using Mind Refuge for 6 weeks" />
          </div>
          <div style={{
      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 600, margin: "0 auto" }}>
          <h2 style={{
            ...
            You deserve to choose<br /><span style={{ color: SAGE }}>where your mind goes.</span>
          </h2>
          <p style={{ fontSize: 17, color: TEXT_MID, lineHeight: 1.72, marginBottom: 36 }}>
            Your attention isn't broken. It just needs a compass. Mind Refuge helps you build one — 25 minutes at a time.
          </p>
          <CTAButton large>Build your self-hypnosis for free</CTAButton>
