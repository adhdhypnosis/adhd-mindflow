...
const SEO = {
  ...
  description: "Years of 'try harder' created shame that runs deep. Self-hypnosis rewrites the story at the root. Free 25-minute session.",
  url: "https://www.adhdselfhypnosis.com/chronic-shame",
  image: "https://www.adhdselfhypnosis.com/og/chronic-shame.jpg",
    ...
    <div style={{ fontFamily: "'Poppins', sans-serif", color: TEXT_DARK, background: BG }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", gap: 60, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 460px", minWidth: 300 }}>
            ...
            <h1 style={{
              ...
              You're not<br />
              <span style={{ color: SAGE }}>broken.</span><br />
              You were just never given the<br />
              <span style={{ color: SAGE }}>right tools.</span>
            </h1>
            ...
            <p style={{
              ...
              89% of women and 81% of men with ADHD carry clinically significant shame. Mind Refuge uses targeted self-hypnosis to help you rewrite the story your brain has been telling you for decades.
            </p>
      ...
      {section(
        <>
          ...
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            <BenefitCard icon="🧠" title="Rewrites the shame narrative" iconAnim="iconPulse"
              desc="Hypnotic suggestions reach below conscious defenses to address the core beliefs — 'I'm lazy,' 'I'm broken,' 'I'm not enough' — and gently replace them at the root." />
      ...
      {section(
        <>
          ...
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            <TestimonialCard
              quote="I've been calling myself lazy since I was 8. After a month of sessions, I caught myself saying 'that was hard for my brain' instead. I cried — but the good kind."
              name="Laura C." detail="Diagnosed at 41 · Using Mind Refuge for 3 months" />
            <TestimonialCard
              quote="The shame was louder than any medication could touch. Mind Refuge went somewhere meds couldn't — the story underneath everything."
              name="Nate R." detail="Diagnosed at 35 · Using Mind Refuge for 2 months" />
            <TestimonialCard
              quote="I stopped apologizing for existing. Not overnight. But I notice it now — the reflex to say sorry for being me. And I can choose not to."
              name="Priya G." detail="Diagnosed at 44 · Using Mind Refuge for 6 weeks" />
          </div>
          <div style={{
      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 600, margin: "0 auto" }}>
          <h2 style={{
            ...
            You deserve to exist<br /><span style={{ color: SAGE }}>without apologizing.</span>
          </h2>
          <p style={{ fontSize: 17, color: TEXT_MID, lineHeight: 1.72, marginBottom: 36 }}>
            The shame was never yours to carry. Mind Refuge helps you put it down — 25 minutes at a time.
          </p>
          <CTAButton large>Build your self-hypnosis for free</CTAButton>
