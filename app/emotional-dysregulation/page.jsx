...
const SEO = {
  ...
  url: "https://www.adhdselfhypnosis.com/emotional-dysregulation",
  image: "https://www.adhdselfhypnosis.com/og/emotional-dysregulation.jpg",
    ...
    <div style={{ fontFamily: "'Poppins', sans-serif", color: TEXT_DARK, background: BG }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", gap: 60, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 460px", minWidth: 300 }}>
            ...
            <h1 style={{
              ...
              <span style={{ color: SAGE }}>too much.</span><br />
              Your brain just moves<br />
              <span style={{ color: SAGE }}>too fast.</span>
            </h1>
            ...
            <p style={{
              ...
              Emotional dysregulation affects up to 70% of adults with ADHD. Mind Refuge uses targeted
              self-hypnosis to help you build the emotional buffer your brain never got.
            </p>
      ...
      {section(
        <>
          ...
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            <BenefitCard icon="🧠" title="Rewires emotional reflexes" iconAnim="iconPulse"
              desc="Targeted suggestions train your nervous system to pause before reacting — building an automatic buffer between feeling and response." />
      ...
      {section(
        <>
          ...
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            <TestimonialCard
              quote="I used to cry at my desk over a Slack message. After two weeks of sessions, I noticed something wild — I'd read a tough email and just... pause. No spiral. That pause didn't exist before."
              name="Aïsha M." detail="Diagnosed at 34 · Using Mind Refuge for 3 months" />
            <TestimonialCard
              quote="My therapist noticed the change before I did. I was describing a conflict with my partner and she said 'you seem calmer about it.' I was. For the first time."
              name="Daniel K." detail="Diagnosed at 29 · Using Mind Refuge for 6 weeks" />
            <TestimonialCard
              quote="I always thought I was just 'too sensitive.' Turns out my brain needed a different kind of training. 25 minutes before bed changed my emotional baseline."
              name="Priya L." detail="Diagnosed at 41 · Using Mind Refuge for 2 months" />
          </div>
          <div style={{
      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 600, margin: "0 auto" }}>
          <h2 style={{
            ...
            You deserve to feel<br /><span style={{ color: SAGE }}>without drowning.</span>
          </h2>
