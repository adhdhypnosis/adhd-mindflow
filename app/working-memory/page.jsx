...
// ─── SEO CONFIG ───
const SEO = {
  title: "Working Memory Deficits & ADHD — Build Your Self-Hypnosis | Mind Refuge",
  description: "Out of sight, out of mind — literally. Self-hypnosis strengthens the memory circuits ADHD weakens. Free 25-minute session.",
  url: "https://www.adhdselfhypnosis.com/working-memory",
  image: "https://www.adhdselfhypnosis.com/og/working-memory.jpg",
    ...
    <div style={{ fontFamily: "'Poppins', sans-serif", color: TEXT_DARK, background: BG }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", gap: 60, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 460px", minWidth: 300 }}>
            ...
            <h1 style={{
              ...
              You're not<br />
              <span style={{ color: SAGE }}>careless.</span><br />
              Your brain just drops things<br />
              <span style={{ color: SAGE }}>mid-thought.</span>
            </h1>
            ...
            <p style={{
              ...
              Up to 81% of adults with ADHD have impaired working memory. Mind Refuge uses targeted self-hypnosis to help you hold onto thoughts your brain keeps letting go.
            </p>
      ...
      {section(
        <>
          ...
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            <BenefitCard icon="🧠" title="Strengthens your mental grip" iconAnim="iconPulse"
              desc="Hypnotic suggestions reinforce the neural circuits responsible for holding information in active memory — so thoughts stop vanishing mid-sentence." />
      ...
      {section(
        <>
          ...
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            <TestimonialCard
              quote="I'd walk into a room and forget why 10 times a day. After 3 weeks of sessions, I started arriving places and still knowing what I came for."
              name="Tom B." detail="Diagnosed at 30 · Using Mind Refuge for 2 months" />
            <TestimonialCard
              quote="My partner's love language is remembering details. I couldn't do it — not because I didn't care, but because my brain dropped everything. These sessions helped me hold on."
              name="Mira S." detail="Diagnosed at 37 · Using Mind Refuge for 3 months" />
            <TestimonialCard
              quote="I used to re-read the same paragraph 8 times. Now I catch myself actually retaining the first read. It's like someone turned up the RAM in my brain."
              name="David H." detail="Diagnosed at 26 · Using Mind Refuge for 6 weeks" />
          </div>
          <div style={{
      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 600, margin: "0 auto" }}>
          <h2 style={{
            ...
            You deserve to hold onto<br /><span style={{ color: SAGE }}>the things that matter.</span>
          </h2>
          <p style={{ fontSize: 17, color: TEXT_MID, lineHeight: 1.72, marginBottom: 36 }}>
            Your brain isn't broken. It just needs a stronger grip. Mind Refuge helps you build one — 25 minutes at a time.
          </p>
          <CTAButton large>Build your self-hypnosis for free</CTAButton>
