...
const SEO = {
  ...
  description: "Time blindness makes every deadline a crisis. Self-hypnosis rewires your brain's internal clock. Free 25-minute personalized session.",
  url: "https://www.adhdselfhypnosis.com/time-blindness",
  image: "https://www.adhdselfhypnosis.com/og/time-blindness.jpg",
    ...
    <div style={{ fontFamily: "'Poppins', sans-serif", color: TEXT_DARK, background: BG }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", gap: 60, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 460px", minWidth: 300 }}>
            ...
            <h1 style={{
              ...
              You're not<br />
              <span style={{ color: SAGE }}>irresponsible.</span><br />
              Your brain just can't<br />
              <span style={{ color: SAGE }}>feel time.</span>
            </h1>
            ...
            <p style={{
              ...
              Up to 90% of adults with ADHD experience time blindness. Mind Refuge uses targeted self-hypnosis to help you build the internal clock your brain never developed.
            </p>
      ...
      {section(
        <>
          ...
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            <BenefitCard icon="🧠" title="Rebuilds your sense of time" iconAnim="iconPulse"
              desc="Targeted suggestions help your subconscious develop a felt sense of duration — so 10 minutes stops feeling the same as 2 hours." />
      ...
      {section(
        <>
          ...
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            <TestimonialCard
              quote="I used to exist in two times: now and not now. After 3 weeks of sessions, I started feeling time passing. It's subtle but it changed everything."
              name="Léa M." detail="Diagnosed at 33 · Using Mind Refuge for 2 months" />
            <TestimonialCard
              quote="I've been fired twice for being late. Not because I didn't care — I literally couldn't feel time moving. These sessions gave me something alarms never could."
              name="Ryan K." detail="Diagnosed at 27 · Using Mind Refuge for 3 months" />
            <TestimonialCard
              quote="My partner used to say 'you're always late because you don't respect my time.' It wasn't that. My brain just couldn't track it. Now it's starting to."
              name="Nina P." detail="Diagnosed at 39 · Using Mind Refuge for 6 weeks" />
          </div>
          <div style={{
      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 600, margin: "0 auto" }}>
          <h2 style={{
            ...
            You deserve to feel<br /><span style={{ color: SAGE }}>time on your side.</span>
          </h2>
          <p style={{ fontSize: 17, color: TEXT_MID, lineHeight: 1.72, marginBottom: 36 }}>
            You're not careless. Your brain just needs a different kind of clock. Mind Refuge helps you build one — 25 minutes at a time.
          </p>
          <CTAButton large>Build your self-hypnosis for free</CTAButton>
