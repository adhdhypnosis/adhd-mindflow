...
// ─── SEO CONFIG ───
const SEO = {
  title: "ADHD Sleep Problems — Build Your Self-Hypnosis | Mind Refuge",
  description: "Racing thoughts at 3am aren't insomnia — they're ADHD. Self-hypnosis quiets the noise so you can finally rest. Free 25-minute session.",
  url: "https://www.adhdselfhypnosis.com/sleep-disturbances",
  image: "https://www.adhdselfhypnosis.com/og/sleep-disturbances.jpg",
    ...
    <div style={{ fontFamily: "'Poppins', sans-serif", color: TEXT_DARK, background: BG }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", gap: 60, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 460px", minWidth: 300 }}>
            ...
            <h1 style={{
              ...
              Your brain won't<br />
              <span style={{ color: SAGE }}>shut up.</span><br />
              And that's why you can't<br />
              <span style={{ color: SAGE }}>sleep.</span>
            </h1>
            ...
            <p style={{
              ...
              60–80% of adults with ADHD have sleep disturbances. Mind Refuge uses targeted self-hypnosis to help you quiet the mental noise your brain produces after dark.
            </p>
      ...
      {section(
        <>
          ...
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            <BenefitCard icon="🧠" title="Quiets the midnight chatter" iconAnim="iconPulse"
              desc="Hypnotic suggestions directly address the racing thoughts and mental replay loops that keep your ADHD brain wired when your body is exhausted." />
      ...
      {section(
        <>
          ...
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            <TestimonialCard
              quote="I used to lie awake replaying every conversation from the day. Now I put on a session and I'm usually asleep before it ends. My Oura ring confirms it."
              name="Kate J." detail="Diagnosed at 34 · Using Mind Refuge for 3 months" />
            <TestimonialCard
              quote="Revenge bedtime procrastination was destroying me. These sessions gave my brain the permission to stop that my willpower never could."
              name="Alex N." detail="Diagnosed at 29 · Using Mind Refuge for 2 months" />
            <TestimonialCard
              quote="I went from 4 hours of broken sleep to 7 hours of actual rest. My psychiatrist asked what changed. I said 'I started listening to something before bed.'"
              name="Jordan T." detail="Diagnosed at 42 · Using Mind Refuge for 6 weeks" />
          </div>
          <div style={{
      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 600, margin: "0 auto" }}>
          <h2 style={{
            ...
            You deserve to rest<br /><span style={{ color: SAGE }}>without a fight.</span>
          </h2>
          <p style={{ fontSize: 17, color: TEXT_MID, lineHeight: 1.72, marginBottom: 36 }}>
            Your brain doesn't need to be silenced. It just needs a gentler off-switch. Mind Refuge helps you build one — 25 minutes at a time.
          </p>
          <CTAButton large>Build your self-hypnosis for free</CTAButton>
