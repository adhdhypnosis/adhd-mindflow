...
const CTAButton = ({ children, variant = "primary", large, to }) => {
...
export default function SymptomLanding({ data }) {
  const { seo, hero, benefit1, testimonials, finalCta } = data;
  ...
  useEffect(() => {
    const id = "symptom-landing-styles";
    ...
    style.textContent = `
      ...
      @keyframes shimmer { 0%, 100% { opacity: 0.4; transform: scale(0.95); } 50% { opacity: 0.8; transform: scale(1.05); } }
      @keyframes iconPulse { 0%, 100% { transform: scale(1); } 50% { transform: scale(1.12); } }
      @keyframes iconFloat { 0%, 100% { transform: translateY(0px); } 50% { transform: translateY(-4px); } }
      @keyframes iconRock { 0%, 100% { transform: rotate(0deg); } 25% { transform: rotate(6deg); } 75% { transform: rotate(-6deg); } }
      @keyframes underlineFlow { 0% { stroke-dashoffset: 0; } 50% { stroke-dashoffset: -14; } 100% { stroke-dashoffset: 0; } }
      @keyframes slowSpin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }
      @keyframes drift { 0%, 100% { transform: translateY(0px) translateX(0px); } 33% { transform: translateY(-8px) translateX(4px); } 66% { transform: translateY(4px) translateX(-6px); } }
      @keyframes breathe { 0%, 100% { transform: scale(1); opacity: 0.25; } 50% { transform: scale(1.08); opacity: 0.4; } }
    ...
    <div style={{ fontFamily: "'Poppins', sans-serif", color: TEXT_DARK, background: BG }}>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <CTAButton variant="secondary" to="/hypnosis-generator">Open the App &rarr;</CTAButton>
        </div>
      </nav>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", gap: 60, flexWrap: "wrap" }}>
          <div style={{ flex: "1 1 460px", minWidth: 300 }}>
            ...
            <h1 style={{
              ...
              {hero.line1}<br />
              <span style={{ color: SAGE }}>{hero.highlight1}</span><br />
              {hero.line2}<br />
              <span style={{ color: SAGE }}>{hero.highlight2}</span>
            </h1>
            ...
            <div style={{
              ...
              <span style={{ fontSize: 14, fontWeight: 500, color: TEXT_DARK }}>
                No sign-up required &middot; 25 minutes &middot; Designed for ADHD brains
              </span>
            </div>
          </div>
          ...
          <div style={{
            ...
            <svg viewBox="0 0 380 420" style={{ position: "relative", zIndex: 1, width: 380, height: 420, overflow: "visible" }}>
              <defs>
              ...
              <image href="/images/hero-adhd.png" x="15" y="10" width="350" height="400" clipPath="url(#heroClip)" preserveAspectRatio="xMidYMin slice" />
            </svg>
      ...
      {section(
        <>
          ...
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            <BenefitCard icon="&#129504;" title={benefit1.title} iconAnim="iconPulse" desc={benefit1.desc} />
            <BenefitCard icon="&#9201;" title="Works in 25 minutes" iconAnim="iconFloat"
      ...
      <div style={{ background: BG, padding: "100px 24px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 960, margin: "0 auto", position: "relative", zIndex: 2 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 760, margin: "0 auto" }}>
            <div style={{ background: WHITE, borderRadius: 20, padding: "32px 28px", border: "1px solid #E8ECEA", display: "flex", gap: 24, alignItems: "flex-start", flexWrap: "wrap" }}>
              <div style={{ minWidth: 56, height: 56, borderRadius: 16, background: SAGE_PALE, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 28 }}><BrainWaveIcon /></div>
              <div style={{ flex: "1 1 300px" }}>
                <h3 style={{ fontSize: 18, fontWeight: 700, color: TEXT_DARK, margin: "0 0 8px", fontFamily: "'Poppins', sans-serif" }}>Your brain is already in the right state</h3>
            ...
            <div style={{ background: WHITE, borderRadius: 20, padding: "32px 28px", border: "1px solid #E8ECEA", display: "flex", gap: 24, alignItems: "flex-start", flexWrap: "wrap" }}>
              <div style={{ minWidth: 56, height: 56, borderRadius: 16, background: SAGE_PALE, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 28 }}>&#9889;</div>
              <div style={{ flex: "1 1 300px" }}>
                <h3 style={{ fontSize: 18, fontWeight: 700, color: TEXT_DARK, margin: "0 0 8px", fontFamily: "'Poppins', sans-serif" }}>It rewires where ADHD is weakest</h3>
                <p style={{ fontSize: 15, color: TEXT_MID, lineHeight: 1.7, margin: 0 }}>
            ...
            <div style={{ background: WHITE, borderRadius: 20, padding: "32px 28px", border: "1px solid #E8ECEA", display: "flex", gap: 24, alignItems: "flex-start", flexWrap: "wrap" }}>
              <div style={{ minWidth: 56, height: 56, borderRadius: 16, background: SAGE_PALE, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 28 }}>&#127919;</div>
              <div style={{ flex: "1 1 300px" }}>
                <h3 style={{ fontSize: 18, fontWeight: 700, color: TEXT_DARK, margin: "0 0 8px", fontFamily: "'Poppins', sans-serif" }}>Hyperfocus is your superpower here</h3>
                <p style={{ fontSize: 15, color: TEXT_MID, lineHeight: 1.7, margin: 0 }}>
      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 600, margin: "0 auto" }}>
          <h2 style={{
            ...
            {finalCta.headline1}<br /><span style={{ color: SAGE }}>{finalCta.headline2}</span>
          </h2>
          <p style={{ fontSize: 17, color: TEXT_MID, lineHeight: 1.72, marginBottom: 36 }}>{finalCta.sub}</p>
          <CTAButton large>Build your self-hypnosis for free</CTAButton>
          <p style={{ fontSize: 13, color: TEXT_LIGHT, marginTop: 14 }}>
            No account needed &middot; Works on any device &middot; Cancel anytime
          </p>
        </div>
      </div>
      ...
      <footer style={{ background: WHITE, borderTop: "1px solid #E8ECEA", padding: "40px 24px" }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 12, color: TEXT_LIGHT }}>&copy; 2026 Mind Refuge &middot; adhdselfhypnosis.com &middot; All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
